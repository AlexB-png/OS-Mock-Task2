...
if __name__ == "__main__":
  ...
  cursor.execute(f"CREATE TABLE IF NOT EXISTS {locations.hotel_booking} (Booking_ID INTEGER PRIMARY KEY, Start_Date STRING, End_Date STRING, Room_Number INTEGER)")
