...
if __name__ == "__main__":
  ...
  cursor.execute(f"CREATE TABLE IF NOT EXISTS {locations.bookings} (Booking_ID INTEGER PRIMARY KEY, Type_Of_Bookings STRING ,Account_ID INTEGER REFERENCES Accounts(Account_ID), Start_date TEXT, End_date TEXT)")
